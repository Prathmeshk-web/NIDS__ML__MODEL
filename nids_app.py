...
with st.sidebar:
    ...
    st.success("✅ Securely connected to IBM Cloud")
    st.markdown("---")
    st.write("⚙️ **Engine:** Scikit-Learn Random Forest")
    st.write("☁️ **Hosting:** IBM Cloud (Dallas)")

# Pull credentials securely from Streamlit's hidden vault
api_key = st.secrets["IBM_API_KEY"]
space_id = st.secrets["IBM_SPACE_ID"]
deployment_id = st.secrets["IBM_DEPLOYMENT_ID"]
